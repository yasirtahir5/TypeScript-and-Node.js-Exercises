...
Objects are storing the album information correctly. Add an optional parameter to make_album() that allows
you to store the number of tracks on an album. If the calling line includes a value for the number of tracks,
add that value to the album’s Object. Make at least one new function call that includes the number of tracks
on an album. */
...
var album1 = make_album("Chet", "Chet Atkins");
var album2 = make_album("Bille", "Bille Joe");
var album3 = make_album("Arlo", "Arlo Guthier", 11);
console.log(album1);
console.log(album2);
console.log(album3);
